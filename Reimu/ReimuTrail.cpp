...
//{
//	x = 0.1*t;
//	y = 20 * sin(t / ANGLE_BASE_DIVISOR/10);
//}
//void trail_circle_0(const int t, int &x, int &y)
//{
//	x = 0.1*t*sin(t / ANGLE_BASE_DIVISOR);
//	y = 0.1*t*cos(t / ANGLE_BASE_DIVISOR);
//}
...
//{
//	x = 0.05*t*sin(t / ANGLE_BASE_DIVISOR);
//	y = 0.1*t*cos(t / ANGLE_BASE_DIVISOR);
//}
//void trail_circle_3(const int t, int &x, int &y)
//{
//	x = 0.1*t*sin(t / ANGLE_BASE_DIVISOR);
//	y = -0.05*t*cos(t / ANGLE_BASE_DIVISOR);
//}
