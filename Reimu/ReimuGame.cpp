...
int main()
{
	...
	for (int i = 0; i < 20; i++)
	{
		...
		f[i].initialization({ 320, 120 }, 5, i / 20.0 * 2 * Pi, trail_circle_1, WHITE, 6000);
		g[i].initialization({ 320, 120 }, 5, i / 20.0 * 2 * Pi, trail_circle_2, RED, 7000);
		h[i].initialization({ 320, 120 }, 5, i / 20.0 * 2 * Pi, trail_circle_3, WHITE, 8000);
	}
